        ...
        return /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mt-1", children: [
              ...
              /* @__PURE__ */ jsx4("span", { className: "text-sm font-medium", children: ((_g = (_f = item.variant) == null ? void 0 : _f.calculated_price) == null ? void 0 : _g.calculated_amount) ? formatPrice(item.variant.calculated_price.calculated_amount * item.quantity, cart.currency_code) : formatPrice(item.total || 0, cart.currency_code) })
            ] })
          ] })
        ] }, item.id);
      }) }),
